...
function HomePage() {
  ...
  // Delete interview and update state
  ...
  // Navigate based on interview status
  ...
  const completedInterviews = allInterviews.filter((i) => i.status === 'completed' && i.overallScore != null);
